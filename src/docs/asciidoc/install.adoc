...
| https://software.jcohy.com/linux/jdk-8u221-linux-x64.tar.gz[jdk-8u221]

https://software.jcohy.com/linux/OpenJDK8U-jdk_x64_linux_hotspot_8u292b10.tar.gz[OpenJDK8U-jdk_x64_linux_hotspot_8u292b10]

https://software.jcohy.com/linux/OpenJDK11U-jdk_x64_linux_hotspot_11.0.11_9.tar.gz[OpenJDK11U-jdk_x64_linux_hotspot_11.0.11_9]
| 无

| tomcat
| CentOS Linux release 7.6
| 7.0.94
| https://software.jcohy.com/linux/apache-tomcat-7.0.94.tar.gz[apache-tomcat-7.0.94]
...
| CentOS Linux release 7.6
| 8.0.19-1.el7.x86_64
| https://software.jcohy.com/linux/mysql-8.0.19-1.el7.x86_64.rpm-bundle.tar[mysql-8.0.19-1.el7.x86_64]
| 无

| redis
| CentOS Linux release 7.6
| 5.0.5
| http://download.redis.io/releases/redis-5.0.5.tar.gz[redis-5.0.5.tar.gz]
| 无

| nginx
| CentOS Linux release 7.6
| 1.6.2
| http://nginx.org/download/nginx-1.6.2.tar.gz[nginx-1.6.2.tar.gz]
| https://software.jcohy.com/linux/nginx-1.6.2.build.tar.gz[编译后下载地址]
...
| https://software.jcohy.com/linux/node-v10.16.0.tar.gz[node-v10.16.0]
| 无
...
| CentOS Linux release 7.6
| v2.3.1
| https://software.jcohy.com/linux/harbor-offline-installer-v2.3.1.tgz[harbor-offline-installer-v2.3.1]
| 无
...
| https://jcohy-software.oss-cn-chengdu.aliyuncs.com/linux/gcc-8.3.0.build.tar.gz[gcc-8.3.0.build]
...
| CentOS Linux release 7.6
| 3.4.5
| https://jcohy-software.oss-cn-chengdu.aliyuncs.com/linux/zookeeper-3.4.5.tar.gz[zookeeper-3.4.5]
| 无
...
. https://software.jcohy.com/linux/redis-5.0.5.tar.gz[下载] redis 安装包
+
[source,shell]
----
wget https://software.jcohy.com/linux/redis-5.0.5.tar.gz
...
mkdir /opt/software
cd /opt/software
wget https://software.jcohy.com/linux/harbor-offline-installer-v2.3.1.tgz
...
| BASH_URL | https://software.jcohy.com/linux/ | 所有所需软件安装包所在的服务器(可以使用 httpd 或者 nginx 等服务器搭建)

| BASH_CONFIG | https://software.jcohy.com/bash/ | 安装所需脚本和配置文件目录
