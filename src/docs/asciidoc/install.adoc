...
由于官方已经开始支持 gitlab 的汉化了，所以开源的社区中文汉化已经不在更新了。最新版的 `twang2218/gitlab-ce-zh` 汉化镜像是基于官方 `gitlab/gitlab-ce:11.1.4-ce.0` 版本进行汉化的。现在我们需要将 gitlab 的版本升级到最新的 13.4.3。
...
现在我们要从 `11.1.4` 升级到 `13.4.3`, 我们的升级路线为 `11.3.4 -&gt; 11.11.8 -&gt; 12.0.12 -&gt; 12.1.17 -&gt; 12.10.14 -&gt; 13.0.14 -&gt; 13.4.3 -&gt; 13.4.7 -&gt; 13.8.8 -&gt;
